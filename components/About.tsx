    ...
    <section id="nosotros" className="bg-accent py-32 md:py-44">
      <div className="container-edge">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-24">
          ...
          >
            No vendemos horas.<br /><span className="inline-block text-paper px-4 py-2 mt-2" style={{ backgroundColor: "#A04220" }}>Entregamos <span className="font-serif italic font-normal">criterio técnico</span>.</span>
          </motion.h2>
          <motion.div
            initial="hidden"
            whileInView="visible"
