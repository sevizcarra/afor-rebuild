  ...
  return (
    <section id="nosotros" className="relative bg-anthracite text-paper py-24 md:py-32">
      <div className="container-edge">
        {/* Lead grande (summary movido desde el hero) con highlighter naranjo por línea */}
        <motion.div
        ...
        >
          <p className="text-h2 font-light leading-[1.4]">
            <span
        ...
        <div className="grid grid-cols-12 gap-6 mb-16 md:mb-24">
          <div className="col-span-12 md:col-span-5">
            ...
            <div className="label text-paper/60 mb-5 tracking-[0.18em]">{t("eyebrow")}</div>
            <motion.h2
          ...
          <div className="col-span-12 md:col-span-7 md:pl-8 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {side.map((txt, i) => (
              ...
              >
                <div className="w-10 h-px bg-paper mb-5" />
                <p className="text-small text-paper/75 leading-relaxed">{txt}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="pt-2" style={{ borderTop: "1px solid rgba(250,250,247,0.15)" }}>
          {principles.map((p, i) => (
            <motion.article
              ...
              className="grid grid-cols-12 gap-6 py-10 md:py-12 items-start group"
              style={{ borderBottom: "1px solid rgba(250,250,247,0.15)" }}
            >
              <div className="col-span-2 md:col-span-1 label text-accent tabular pt-2 font-semibold">{p.n}</div>
              <h3 className="col-span-10 md:col-span-3 font-sans font-bold text-paper text-h3">
                {p.title}
              </h3>
