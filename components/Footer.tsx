      ...
      <div className="container-edge">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          ...
          <ul className="md:text-right space-y-3 text-small">
            <li><a href={SITE.dossierUrl} className="text-paper/70 hover:text-accent transition-colors">Descargar portafolio</a></li>
        ...
        <div className="border-t border-paper/10 pt-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-small text-paper/40">
          <span>© {new Date().getFullYear()} AFOR. Todos los derechos reservados.</span>
          <span className="font-mono tracking-wider">{SITE.address}</span>
        </div>
      </div>
    </footer>
  );
